...
// const [...genre] = genres;
// console.log(title, genres, others);

//* Spread Operator
// const newBook = { bookname: "epic", ...book }; // add/update new prop in book object
// const newGenre = ["epic", ...genres]; // add/update new item in genres array
// // we can overwrite object property
// console.log(newBook);
